...
$c741cbfe1353d8c3$var$app.use((0, $iPS4O$express).static((0, $iPS4O$path).join($c741cbfe1353d8c3$var$__dirname, "frontend/build/")));
// Роуты
...
$c741cbfe1353d8c3$var$app.get("*", function(req, res) {
    res.sendFile((0, $iPS4O$path).join($c741cbfe1353d8c3$var$__dirname, "frontend/build/index.html"), function(err) {
